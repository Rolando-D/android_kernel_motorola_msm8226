...
if [ -d ../android_prebuilt_toolchains ]; then
	...
	echo "3) 4.9 Ubertc GCC"
	echo "4) 5.1 Ubertc GCC"
	echo "5) 4.9.3 Linaro GCC"
	...
	case "$toolchain" in
		...
		3 ) export CROSS_COMPILE="../android_prebuilt_toolchains/arm-eabi-4.9/bin/arm-eabi-"; ToolchainCompile="Ubertc 4.9";;
		4 ) export CROSS_COMPILE="../android_prebuilt_toolchains/arm-eabi-5.1/bin/arm-eabi-"; ToolchainCompile="Ubertc 5.1";;
		5 ) export CROSS_COMPILE="../android_prebuilt_toolchains/arm-cortex-linux-gnueabi-linaro_4.9.3-2015.03/bin/arm-cortex-linux-gnueabi-"; ToolchainCompile="Linaro 4.9.3";;
